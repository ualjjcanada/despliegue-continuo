...
[NOTE]
====
Si abres el repositorio de PetClinic con VS Code, verás que el IDE te sugiere abrir el proyecto en un entorno https://code.visualstudio.com/docs/devcontainers/containers[_Dev Containers_]. Esto *no es necesario*. 
